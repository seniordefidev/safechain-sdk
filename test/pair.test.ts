...
describe('Pair', () => {
  ...
  const USDC = new Token(ChainId.TESTNET, '0x64544969ed7ebf5f083679233325356ebe738930', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.TESTNET, '0xec5dcb5dbf4b114c9d0f65bccab49ec54f6a0867', 18, 'DAI', 'DAI Stablecoin')
